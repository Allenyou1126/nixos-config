...
let
  cfg = config.services.allenyou.wakapi;
...
in
{
  options.services.allenyou.wakapi = {
    ...
    databasePassword = mkOption {
      ...
      default = null;
      description = ''
        The password used for the database connection used by Wakapi.
      '';
    };
    databasePasswordFile = mkOption {
      ...
      default = null;
      description = ''
        The path to a file containing the password for the database connection used by Wakapi.
      '';
    };
    ...
    systemd.services.wakapi = {
      ...
      serviceConfig = {
        Environment = mkMerge [
          ...
          (mkIf (cfg.databasePassword != null) "WAKAPI_DB_PASSWORD=${cfg.databasePassword}")
        ];

        EnvironmentFile =
          (lib.optional (cfg.passwordSaltFile != null) cfg.passwordSaltFile)
          ++ (lib.optional (cfg.smtpPasswordFile != null) cfg.smtpPasswordFile)
          ++ (lib.optional (cfg.databasePasswordFile != null) cfg.databasePasswordFile);
