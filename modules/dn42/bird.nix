    ...
    let
      ...
      mpBgpPart =
        if peer.multiProtocolV4 then
          ...
          '';
    in
    sessionHead + sessionBody + mpBgpPart + sessionEnd;
      ...
      config =
        let
          ...
          staticConfig =
            ...
            + "\n";
        in
        commonConfig + roaConfig + rpkiConfig + templateConfig + peeringConfig + staticConfig;
    };
    users = {
      users.bird = {
